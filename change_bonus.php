...
<body>
    ...
    <div class="container">
        ...
        if(isset($_POST['submit']))
        {
            ...
            mysqli_query($db, $sql);
            $sql="INSERT INTO `history_bonus`(`emp_id`, `entrier_id`,`date`, `amount`,`remarks`,`entry_date`,`approval_date`,`ref`) VALUES ('$emp','$entrier','$eff_date','$increment','$remarks','$date','$appr_date','$ref')";
            mysqli_query($db, $sql);
            $comment="You have been Awarded Taka ".$increment." (Effective Date: ".date_format(date_create($eff_date),"d-M-Y") . ").";
            $sql="INSERT INTO `notification`(`emp_id`, `type`, `date`, `comment`,`ref`) VALUES ('$emp','Bonus','$date','$comment','$ref')";
            mysqli_query($db,$sql);
        ...
        if(!isset($_POST['submit']))
        {
            ...
            <form action="" method="post">
                Bonus Amount(Taka): <input name='inc' type='number' class="form-control" style='width:200px' required><br><br>
