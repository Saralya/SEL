...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="">
            ...
            $query="SELECT * FROM history_employment WHERE `serial`='$id'";
...
".$old_rem;
                ...
                $sql="UPDATE history_employment SET remarks='$remark',date='$new_date' WHERE `serial`='$id'";
                mysqli_query($db,$sql);
                mysqli_query($db,"UPDATE job_status SET employee_separation_date='$new_date' WHERE emp_id='$emp_id'");
            ...
            <form method="post" action="">
                ...
                <label for="new_date">Update Date:</label>
                <input type="date" name="new_date" value="<?php echo $date;?>" class="form-control" style="width:200px">
                <br>               
